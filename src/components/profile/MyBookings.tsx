...
import { Bike, Calendar, Clock, IndianRupee, MapPin, Navigation, CheckCircle, AlertCircle, Search } from "lucide-react";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "../ui/card";
import { Badge } from "../ui/badge";
...
const MyBookings = () => {
  ...
  const activeBookings = bookingHistory.filter(booking => booking.status === 'Active');
  const completedBookings = bookingHistory.filter(booking => booking.status === 'Completed');
    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Track your rental history and current bookings</p>
        </div>
      </div>
        ...
        <Card className="bg-gradient-to-r from-green-50 to-green-100 border-green-200 hover:shadow-md transition-shadow">
          <CardContent className="p-4 ">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-600">Active Rentals</p>
      ...
      {/* Bookings List */}
      <div className="mb-6">
        <h2 className="text-xl text-gray-900 font-semibold mb-1">Booking History</h2>
        <p className="text-gray-600">Your complete rental history and current active bookings</p>
      </div>
                    ...
                    <div className="flex items-start gap-3 sm:gap-4 mb-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col gap-2 mb-2">
                          <h3 className="text-lg font-semibold text-gray-900 truncate">{booking.bikeModel}</h3>
                    ...
                    <div className="space-y-3 mb-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                          ...
                          <div className="min-w-0">
                            <p className="text-xs font-medium text-blue-600 uppercase tracking-wide">Pickup</p>
                        ...
                        <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-lg">
                          ...
                          <div className="min-w-0">
                            <p className="text-xs font-medium text-purple-600 uppercase tracking-wide">Drop-off</p>
                            <p className="text-sm font-medium text-gray-900 truncate">{booking.dropLocation}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-green-700">
                              Started on {formatDate(booking.startDate)} at {booking.startTime}
                            </p>
