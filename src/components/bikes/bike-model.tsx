...
//       setCartCountByColor({}); // clear all cart counts per color
...
//       <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl scrollbar-hidden">
//         {/* Header */}
...
//                 ? `${cartCountByColor[selectedColor]} added`
//                 : "Add to Cart"}
//             </button>
