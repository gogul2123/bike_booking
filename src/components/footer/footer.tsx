  ...
  return (
    <footer className="bg-gradient-to-br from-[#141414] via-gray-800 to-[#141414] text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 text-sm leading-relaxed max-w-md">
              ...
              across India. Your trusted partner for safe, affordable, and
              convenient motorcycle adventures.
            </p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    78/B Cheran Tower Near Railway Station
                    <br />
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-gray-300 hover:text-[#AC9456] text-sm transition-colors"
                  >
                    +91 93421 53995
                  </a>
                </div>
          ...
          <div className="lg:pl-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
              {/* Features */}
              <div>
                <h4 className="text-[#AC9456] font-semibold text-sm mb-3 uppercase tracking-wide">
                  Features
                </h4>
      ...
      <div className="border-t border-gray-700">
        <div className="container mx-auto px-4 sm:px-6 lg:px-6 xl:px-8  py-6 ">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              <p className="text-gray-400 text-sm">
                © {new Date().getFullYear()} Indian Bike Rental. All rights
                reserved.
              </p>
            </div>
