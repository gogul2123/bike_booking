...
const BikeCategoriesSection: React.FC<BikeCategoriesSectionProps> = ({
  categories,
}) => {
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 mb-6">
                  <h4 className="sm:hidden text-sm font-semibold text-[#AC9456] uppercase tracking-wider">
                    Available Models
                  </h4>
                ...
                <div className="sm:hidden bg-gray-50 rounded-lg p-4 mb-6">
                  <div className="grid grid-cols-2 gap-4 text-xs">
                    <div className="text-center">
                      <div className="text-[#AC9456] font-semibold">
                        ✓ Verified
                      </div>
