        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-8 sm:mb-10 lg:mb-12 leading-relaxed max-w-2xl lg:max-w-3xl mx-auto px-2">
              Join thousands of satisfied customers who trust us for their bike
              rental needs. Book now and experience the freedom of the road!
            </p>
            ...
            <div className="text-xs sm:text-sm text-gray-500 space-y-1">
              <p>
                ✓ Instant confirmation • ✓ Free cancellation • ✓ Best price
                guarantee
              </p>
