                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex items-center space-x-2">
                          <button
                            onClick={() =>
                              updateQuantity(getItemKey(item), Math.max(1, item.quantity - 1))
                            }
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex items-center space-x-2">
                          <button
                            onClick={() =>
                              updateDays(getItemKey(item), Math.max(1, item.days - 1))
                            }
                            className="p-1 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors duration-200"
                          ...
                          <button
                            onClick={() => updateDays(getItemKey(item), item.days + 1)}
                            className="p-1 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors duration-200"
                          >
                            <Plus className="w-3 h-3" />
                          </button>
                    ...
                    <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                      <span className="text-sm text-gray-600">
                        ₹{item.price_per_day_INR}/day × {item.days} days × {item.quantity}
                      </span>
